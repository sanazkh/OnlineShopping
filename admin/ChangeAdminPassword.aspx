<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ChangeAdminPassword.aspx.cs" Inherits="admin_ChangeAdminPassword" %>
...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="main">
            ...
            <div id="content">
                <br /><br />
                <asp:Label ID="Label13" runat="server" Text="تغییر پسورد" style="margin-right: 10px"></asp:Label><br /><br /><br />
                <asp:Label ID="Label3" runat="server" Text=" پسورد کنونی   : * " style="margin-right: 10px"></asp:Label><br />
                <asp:TextBox ID="TextBox1" runat="server" Width="300px" style="margin-right: 10px" TextMode="Password"></asp:TextBox><br />
                <asp:Label ID="Label5" runat="server" Text="پسورد جدید  : * " style="margin-right: 10px"></asp:Label><br />
                <asp:TextBox ID="TextBox2" runat="server" Width="300px" style="margin-right: 10px" TextMode="Password"></asp:TextBox><br />
                <asp:Label ID="Label6" runat="server" Text="تأیید پسورد جدید  : * " style="margin-right: 10px"></asp:Label><br />
                <asp:TextBox ID="TextBox3" runat="server" Width="300px" style="margin-right: 10px" TextMode="Password"></asp:TextBox><br /><br />
                <asp:Button ID="Button1" runat="server" Text="ثبت" Width="50px"  
                    style="margin-right: 10px" onclick="Button1_Click"/><br /><br />
                    <asp:Label ID="Label90" runat="server" Visible="false" style="margin-right: 10px"></asp:Label>
            </div>
            <div id="right-side">
                <br />
                ...
                <asp:LinkButton ID="LinkButton5" runat="server" style="margin-right: 10px" 
                    onclick="LinkButton5_Click">خروج</asp:LinkButton><br />
            </div>
        </div>
        <div id="footer">
