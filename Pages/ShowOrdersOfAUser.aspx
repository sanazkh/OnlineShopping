<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ShowOrdersOfAUser.aspx.cs" Inherits="Pages_ShowOrdersOfAUser" %>
    ...
    <div id="wrapper">
        ...
        <div id="main">
           ...
           <asp:GridView ID="GridView1" runat="server" Height="402px" 
            ...
            <div id="content">
            <br />
                <asp:Label ID="Label4" runat="server" Text="لیست سفارشات تأیید شدۀ شما تا به حال" style="margin-right: 140px"></asp:Label>
            <asp:GridView ID="GridView2" runat="server" Height="497px" OnPageIndexChanging="GridViewPageEventHandler" 
                    AutoGenerateColumns="false" style="margin-right: 9px; margin-top: 18px" 
                    Width="462px" AllowPaging="true">
                    <Columns>
                    <asp:BoundField DataField="OrderID" HeaderText="شناسه سفارش"/>
                    </Columns>
                    <Columns>
                    <asp:BoundField DataField="OrderDate" HeaderText="تاریخ سفارش"/>
                    </Columns>
                    <Columns>
                    <asp:BoundField DataField="DepositNo" HeaderText="شماره فیش واریزی"/>
                    </Columns>
                    <Columns>
