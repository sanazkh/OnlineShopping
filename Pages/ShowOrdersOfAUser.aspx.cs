...
public partial class Pages_ShowOrdersOfAUser : System.Web.UI.Page
{
    TopTenProductsListFunction topTenProducts = new TopTenProductsListFunction();
    ShowOrdersOfaUserFunction sooauf = new ShowOrdersOfaUserFunction();
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        GridView1.DataBind();
        GridView2.DataSource = sooauf.ShowOrdersOfaUser(id);
        GridView2.DataBind();
