<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ThanksForOrder.aspx.cs" Inherits="Pages_ThanksForOrder" %>
           ...
           <asp:GridView ID="GridView1" runat="server" Height="401px" 
            ...
            <div id="content">
                ...
                <asp:Label ID="Label4" runat="server" 
                    Text="ممنون از خرید. سفارش شما ظرف هفتۀ آینده به دستتان خواهد رسید." 
                    style="margin-right: 50px"></asp:Label><br /><br />
                <asp:Image ID="Image2" runat="server" Height="403px" 
                    ImageUrl="~/images/Hydrangeas.png" style="margin-right: 13px" Width="459px" />
            </div>
            <div id="right-side">
                 <br />
