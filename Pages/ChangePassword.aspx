...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="main">
            ...
            <div id="content">
                <br /><br />
                <asp:Label ID="Label3" runat="server" Text="تغییر پسورد" style="margin-right: 10px"></asp:Label><br /><br /><br />
                <asp:Label ID="Label4" runat="server" Text=" پسورد کنونی   : * " style="margin-right: 10px"></asp:Label><br />
            ...
            <div id="right-side">
                 <br />
                <asp:Label ID="Label17" runat="server" Text="کاربر:" style="margin-right: 10px"></asp:Label>
