<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AboutUsAfterLogin.aspx.cs" Inherits="Pages_AboutUs" %>
        ...
        <div id="main">
            ...
            <div id="content">
              <asp:TextBox ID="TextBoxAbout" Font-Size="Large" runat="server" ReadOnly="true" 
                    TextMode="MultiLine" Height="390px" Width="448px" style="margin-right: 11px; margin-left:11px; text-align:justify"
