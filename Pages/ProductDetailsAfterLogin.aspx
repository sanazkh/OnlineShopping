<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ProductDetailsAfterLogin.aspx.cs" Inherits="Pages_ProductDetails" %>
    ...
    <div id="wrapper">
        ...
        <div id="links">
            <ul>
                ...
                <li><asp:LinkButton ID="LinkButton11" runat="server" onclick="LinkButton10_Click">ثبت نام در سایت</asp:LinkButton> | &nbsp;</li>
           ...
           <asp:GridView ID="GridView1" runat="server" Height="403px" 
            ...
            <br /><br /><br />
                ...
                <asp:Image ID="Image2" runat="server" style="margin-right: 10px" Height="175px" 
                    Width="238px"/><br /><br />
                <asp:LinkButton ID="LinkButton6" CommandName="Select" runat="server" style="margin-right: 10px">بازگشت به لیست محصولات همین مجموعه</asp:LinkButton><br />
                <asp:LinkButton ID="LinkButton13" CommandName="Select" runat="server" 
                    style="margin-right: 10px" onclick="LinkButton13_Click">افزودن به سبد خرید</asp:LinkButton><br /><br />
                <asp:Label ID="Label14" runat="server" Text="Label" Visible="false" style="margin-right: 10px"></asp:Label>
            </div>
            <div id="right-side">
                <br />
                ...
                <asp:LinkButton ID="LinkButton12" runat="server" style="margin-right: 10px" 
